...
def single_inference():
    ...
    psnr1 = calculate_psnr_pil(img, input_org_img)
    print(f"input PSNR: {psnr1:.2f} dB")
    psnr2 = calculate_psnr_pil(img, output)
    print(f"output PSNR: {psnr2:.2f} dB")
    
    if psnr2 < psnr1:
        print("output PSNR is worse than input PSNR")
